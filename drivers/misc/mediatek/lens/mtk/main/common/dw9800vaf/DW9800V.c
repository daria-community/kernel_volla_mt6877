...
static int s4DW9800V_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long DW9800V_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9800V_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9800V_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9800V_GetFileName(unsigned char *pFileName)
{
