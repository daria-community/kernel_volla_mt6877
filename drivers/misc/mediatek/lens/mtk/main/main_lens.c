...
/*prize add by xiaguohong 20250103 start*/
	{1, AFDRV_DW9800V, DW9800V_SetI2Cclient, DW9800V_Ioctl,
	 DW9800V_Release, DW9800V_GetFileName, NULL},
/*prize add by xiaguohong 20250103 end*/
};
